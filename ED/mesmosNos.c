...
int busca(TNoA *raiz1, TNoA *raiz2){
    ...
    return(busca(raiz1, raiz2->esq) || busca(raiz1, raiz2->dir)); //O valor procurado está na subarvore esquerda ou na subarvore direita?
}
...
int mesmos_nos(TNoA *a1, TNoA *a2) {
    ...
    if (mesmos_nos(a1->esq, a2) == 0)
        return 0;

    if (mesmos_nos(a1->dir, a2) == 0)
        return 0;
